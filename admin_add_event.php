...
<html>
    ...
    <body>
        <?php
        //header
        $pageTitle = "ADD EVENT"; //put your page title
        include './includes/admin/event/admin_eventId_generator.php';
        include './includes/admin/admin_header.php';

        //article
        include './includes/admin/event/add_event_article.php';
