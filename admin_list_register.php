...
<!--
   ...
   Filename: admin_list_booking.php
...
<html>
    <head>
        ...
        <link href="css/admin_list_register.css" rel="stylesheet"/>
    ...
    <body>
        <?php
        //header
        $pageTitle = "EVENT REGISTER LIST";
        include './includes/admin/admin_header.php';

        //article
        include './includes/admin/register/list_register_article.php';
