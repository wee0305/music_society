...
<html>
    <head>
        ...
        <script>
            $(document).ready(function () {
                $("#editAvatar").on("keyup input", function () {
                    var img = $("#memberImg").val().replace(/C:\\fakepath\\/i, '');
                    if (img !== "" || img !== null) {
                        $("form").submit();
                    }
                });
    ...
    <body>
        ...
        include './includes/member/member_profile_content.php';
