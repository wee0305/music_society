...
<!--
   ...
   Filename: member_enrollment_list.php
...
<html>
    <head>
        ...
        <link href="css/style_member_enrollment_list.css" rel="stylesheet"/>
    ...
    <body>
        <?php
        $headTitle = "MY ENROLLMENT LIST";
        include './includes/member/member_header.php';
        include './includes/member/function_helper.php';
        include './includes/member/member_enrollment_list_content.php';
