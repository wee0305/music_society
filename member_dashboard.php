...
<html>
    <head>
        ...
        <link href="css/style_member_dashboard.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <?php
        $headTitle = "MEMBER DASHBOARD";
        include './includes/member/member_header.php';
        include './includes/member/member_content.php';
